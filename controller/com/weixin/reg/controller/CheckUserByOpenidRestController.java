...
public class CheckUserByOpenidRestController {

	@Autowired
	IWeixinUserinfoModelMapper weixinUserinfoModelMapper;
	
	
	@RequestMapping(value = "/checkUserByOpenid", method = RequestMethod.POST)
	public OutPutParam checkUserByOpenid(@RequestBody InputParam inputParam, HttpServletRequest request , Model model) {
		//回传参数
		...
		String mOpenID = mParams.get("openid").toString() ;

		//查询是否存在这个openid
		WeixinUserinfoModel mWeixinUserinfo = weixinUserinfoModelMapper.selectByOpenID(mOpenID);
