...
public class SendValidateSMS_Ali {

	public static void SendValidateSMS(String pPhone , String pCode) throws Exception {
		...
		//组装请求对象
		 ...
		 request1.setPhoneNumbers(pPhone);
		 //必填:短信签名-可在短信控制台中找到
		 ...
		 request1.setTemplateParam("{\"code\":\""+pCode+"\"}");
		...
		System.out.println("短信发送返回值："+sendSmsResponse.getCode());
